...
namespace NaughtyAttributes.Test
{
    public class LayerTest : MonoBehaviour
    {
        ...
        public void DebugLog()
        {
            ...
            Debug.LogFormat("LayerToName({0}) = {1}", this.layerNumber0, LayerMask.LayerToName(this.layerNumber0));
            Debug.LogFormat("NameToLayer({0}) = {1}", this.layerName0, LayerMask.NameToLayer(this.layerName0));
        }
    }
